...
//Starting servers solveSearchProblemServer.start(); mazeGeneratingServer.start();
                    ...
                    IClientStrategy() {
                        ...
                        public void clientStrategy(InputStream inFromServer, OutputStream outToServer) {
                            try {
                                ...
                                26 | P a g e
                                        %s", serverResponse));
                                String message = "Client Message"; String serverResponse; toServer.write(message + "\n"); toServer.flush();
                                serverResponse = fromServer.readLine(); System.out.println(String.format("Server response:
